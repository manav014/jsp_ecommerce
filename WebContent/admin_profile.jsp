...
<!--HTML5 DECLARARTION-->
 ...
 <h3>MODIFY ASSETS</h3>
 <br>
 <a href="add_assets.jsp" class="btn btn-primary">ADD</a></br></br>
 <form action="show_assets.jsp" method="POST">
<div class="form-group">
 ...
 <a href="admin_update.jsp" class="btn btn-success">UPDATE</a>
 </br>
 </br>
 </br>
 <h3>DELETE USER</h3>
 <form action="backend/delete_user.jsp" method="POST">
<div class="form-group">
...
<p style="color:green;">
<%
	if(session.getAttribute("crrm")!=null)
	{
		out.println((String)session.getAttribute("crrm"));
		session.removeAttribute("crrm");
	}
%>
</p>
<p style="color:red;"><%
	if(session.getAttribute("errm")!=null)
	{
		out.println((String)session.getAttribute("errm"));
		session.removeAttribute("errm");
	}
%>
</p>
